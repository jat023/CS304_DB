...
public class Tables {
    ...
    public static final String PURCHASABLE_GAME_ATTR_DISCOUNTPRICE = "discountPrice";
    ...
    public static void addNewPurchasableGame(PurchasableGame aPurchasableGame) throws SQLException {
        String insertFinalizedGameSQL = "INSERT INTO " + Tables.PURCHASABLE_GAME_TABLENAME
                ...
                + PURCHASABLE_GAME_ATTR_DISCOUNTPRICE
                + ") VALUES "
                + "(?,?,?,?,?,?,?,?)";
        ...
        preparedStatement.setFloat(8, aPurchasableGame.getDiscountPrice());
